...
def main(
    ...
    for index, row in df.iterrows():
        sys_content = "Consider only abstracts including keywords (separated by commas), in English, in the area: "+row['area'].strip()+" ("+row['Domain'].strip()+")"
        user_content = "Generate an abstract of scientific paper"
