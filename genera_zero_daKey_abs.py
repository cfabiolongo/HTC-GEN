...
def main(
    ...
    output = "results/results_abstract_da20Key-100v2_generation.txt"
    ...
    # taxonomy+keywords:
    taxonomy = 'dataset/lista_total_20keywords.xlsx'
    ...
    for index, row in df.iterrows():
        ...
        excel_gen = "dataset/zeroshot_da20Keywords-100v2_wos.xlsx"
